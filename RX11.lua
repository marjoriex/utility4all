...
function RX11:draw_string_custom(string_content, int_x, int_y, int_font, int_size, bool_center, bool_visible, bool_outline, color3_color, color3_outline_color) 
    local RX11_STRING_OUTLINE = Drawing.new("Text")
    ...
    RX11_STRING_OUTLINE.Text = string_content
    RX11_STRING_OUTLINE.Outline = bool_outline
    RX11_STRING_OUTLINE.Position = Vector2.new(int_x, int_y)
    RX11_STRING_OUTLINE.Color = color3_color
